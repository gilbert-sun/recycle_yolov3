...
#    src1 = "/home/dgx/recycle_yolo/dataset/out_aug_data103_maxpool_rotate30/"
#    count_total_pet_class(src1)
#    sum = (lambda ct_all : (int(ct_all.count("0"))+ int(ct_all.count("1"))+ int(ct_all.count("2"))+ int(ct_all.count("3"))+ int(ct_all.count("4"))+ int($
    # print (sum(ct_all))
#    print("\nFinal---f_count:{}--:pet_total:{}--- P):{}-{}% ,O):{}-{}% ,S):{}-{}% ,C):{}-{}% ,Ot):{}-{}% ,T):{}-{}% ,Ch):{}-{}% ! \n ".format( fcount,
 #                                                                                     sum(ct_all),
 #                                                                                     ct_all.count("0"),{float(int(ct_all.count("0"))/sum(ct_all)*100)},
